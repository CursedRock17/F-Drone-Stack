#ifndef F_DRONE_SIMULATION__DRONE_AUTO_SIM_HPP_
#define F_DRONE_SIMULATION__DRONE_AUTO_SIM_HPP_
...
namespace f_drone_gazebo
{
  ...
  private:
    std::unique_ptr<DroneAutoSimPrivate> dataPtr;
  };
}  // Namespace: f_drone_gazebo

#endif  // F_DRONE_SIMULATION__DRONE_AUTO_SIM_HPP_
