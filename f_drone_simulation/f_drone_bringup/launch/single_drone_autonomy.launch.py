...
def generate_launch_description():
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={"gz_args": PathJoinSubstitution([
            "worlds", "drone_world_autonomous.sdf"
        ])}.items(),
    )
    ...
    # GZ_SIM_RESOURCE_PATH / GZ_SIM_SYSTEM_PLUGIN_PATH are set by the
    # f_drone_description and f_drone_gazebo colcon environment hooks.
